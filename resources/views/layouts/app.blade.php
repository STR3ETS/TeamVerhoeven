...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#faf5f2] min-h-screen max-h-screen flex flex-col md:flex-row">
        @php
            ...
            $mustIntake = false;
            if ($user) {
                $ctrl = app(\App\Http\Controllers\MagicLoginController::class);
                $mustIntake = method_exists($ctrl, 'requiresIntake') && $ctrl->requiresIntake($user);
            }
        @endphp
                    ...
                    @if(auth()->user()->role === 'coach')
                        <li>
                            @if($mustIntake)
                                <span class="p-2 rounded bg-[#a89066]/50 text-black/60 flex items-center gap-2 cursor-not-allowed pointer-events-none"
                                    ...
                                    <i class="min-w-4 fa-solid fa-house fa-xs text-black/50"></i>
                                    <span class="font-semibold text-xs pt-0.5">Overzicht</span>
                                </span>
                            @else
                        ...
                        <li>
                            @if($mustIntake)
                                <span class="p-2 rounded bg-[#a89066]/50 text-black/60 flex items-center gap-2 cursor-not-allowed pointer-events-none"
                                      title="Rond eerst je intake af">
                                    <i class="min-w-4 fa-solid fa-ban fa-xs text-black/50"></i>
                                    <span class="font-semibold text-xs pt-0.5">Ongeclaimde klanten</span>
                                </span>
                            @else
                                <a href="{{ route('coach.clients.claim') }}" class="p-2 rounded bg-[#a89066] transition duration-300 flex items-center gap-2">
                        ...
                        <li>
                            @if($mustIntake)
                                <span class="p-2 rounded bg-[#a89066]/50 text-black/60 flex items-center gap-2 cursor-not-allowed pointer-events-none"
                                      title="Rond eerst je intake af">
                                    <i class="min-w-4 fa-solid fa-dumbbell fa-xs text-black/50"></i>
                                    <span class="font-semibold text-xs pt-0.5">Klanten</span>
                                </span>
                            @else
                    ...
                    @if(auth()->user()->role === 'client')
                        ...
                        <li>
                            @if($mustIntake)
                                <span class="p-2 rounded bg-[#a89066]/50 text-black/60 flex items-center gap-2 cursor-not-allowed pointer-events-none"
                                      title="Rond eerst je intake af">
                                    <i class="min-w-4 fa-solid fa-shopping-bag fa-xs text-black/50"></i>
                                    <span class="font-semibold text-xs pt-0.5">Supplementen</span>
                                </span>
                            @else
                ...
                @auth
                    ...
                    @if(auth()->user()->role === 'coach')
                        ...
                        <li>
                            ...
                            @else
                                <a href="{{ route('coach.clients.claim') }}" class="p-2 rounded hover:bg-[#a89066] transition duration-300 flex items-center gap-2">
                                    <i class="min-w-4 fa-solid fa-ban fa-xs text-black"></i>
                                    <span class="text-black font-semibold text-xs pt-0.5">Ongeclaimde klanten</span>
                                </a>
                            @endif
