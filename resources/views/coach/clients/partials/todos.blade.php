        ...
        <li class="py-3 flex items-start gap-4" data-id="{{ $item->id }}">
            ...
            <div class="flex-1" x-data="{ edit:false }">
                ...
                <div>
                    ...
                    @if($item->due_date) • deadline: {{ \Illuminate\Support\Carbon::parse($item->due_date)->format('d-m-Y') }} @endif
                    @if($item->is_optional) • optioneel @endif
                    </div>
                ...
                <textarea name="notes" rows="2" maxlength="2000"
                            ...
                            class="w-full rounded-xl border border-gray-300 hover:border-[#c7c7c7] transition p-2 text-sm focus:outline-none focus:ring-0">{{ old('notes', $item->notes) }}</textarea>
